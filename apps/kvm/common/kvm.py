...
from apps.kvm.common.rwlock import ReadWriteLock
...
c = {
    'ssh': {'type': 2, 'port': 22},
    'tls': {'type': 3, 'port': 16514},
    'tcp': {'type': 1, 'port': 16509},
}
        ...
        if connection is None:
            ...
            try:
                ...
                if connection is None:
                    ...
                    connection = KvmConnection(host, login, passwd, conn)
