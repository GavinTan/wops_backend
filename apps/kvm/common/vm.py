...
from apps.kvm.common.storage import VmStorage, VmStorages
...
class KvmVmBase(KvmBase):
    ...
    def get_snapshot(self):
        ...
        for snapshot in snapshot_list:
            ...
            snap_time_create = utils.get_xml_path(snap.getXMLDesc(0), "/domainsnapshot/creationTime")
    ...
    def get_vm_storage(self, pool):
        return VmStorage(self.host, self.login, self.passwd, self.conn, pool)

    def get_vm_storages(self):
        return VmStorages(self.host, self.login, self.passwd, self.conn)
